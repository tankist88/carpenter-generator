...
import static com.github.tankist88.carpenter.core.util.ConvertUtil.toFieldProperties;
...
public class CreateMockFieldCommandTest {
    ...
    public void testMockFieldDeclaration() {
        ...
        assertTrue(
                fieldExtInfo1.getBody().contains("private com.github.tankist88.carpenter.generator.command.CreateMockFieldCommandTest.GenericTestMockFieldDeclarationClass<java.lang.Long, java.lang.Double> testField;")
        );
        ...
        assertTrue(fieldExtInfo1.getBody().contains("@Mock"));
        assertTrue(
                fieldExtInfo2.getBody().contains("private com.github.tankist88.carpenter.generator.command.CreateMockFieldCommandTest.WithoutGenericTestMockFieldDeclarationClass testFieldNoGen;")
        );
    }
